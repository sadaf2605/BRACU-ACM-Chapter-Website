...
(function($){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['Source java library' ,'java','C++'/*,'demos'*/]) >=0 ){
    ...
    var that = {
      ...
      update:function(){
        ...
        switch (_path){
          ...
          document.title = "Source code library"
          break
          ...
          document.title = "Source java library » " + _path
          break
        }
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"Source java library":{color:"red", shape:"dot", alpha:1}, 
      
           

			"C++":{color:CLR.branch, shape:"dot", alpha:1},
			
			
             java:{color:CLR.branch, shape:"dot", alpha:1},
             "fasterIO":{color:CLR.java, alpha:0, link:'http://bracu.acm.org/sourcecode/library/Faster_Input_Output_java_View3.html'},
             "Sorting":{color:CLR.java, alpha:0, link:'#'}
            },
      edges:{
        "Source java library":{
          java:{length:.8},
